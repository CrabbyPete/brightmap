...
class Chapter( models.Model ):
    ...
    letter        = models.CharField( default = None, max_length = 255 )
    ...
    def interests(self):
        deals = self.deals()
        return [ deal.interest for deal in deals]
...
class Interest(models.Model):
    ...
    def events(self, day = None, open_interest = False ):
...
class Event(models.Model):
    ...
    def interests(self, open_interest = False ):
        """
...
class ConnectionManager(models.Manager):
    ...
    def for_event(self, event ):
        ...
        for survey in event.surveys():
            connects = self.filter(survey = survey)
